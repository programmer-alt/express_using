...
import express from "express"; // Импортируем Express и типы Request и Response
...
app.get("/city/drop", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { rows } = yield pool.query('SELECT city_name FROM cities'); // Выполняем SQL-запрос
